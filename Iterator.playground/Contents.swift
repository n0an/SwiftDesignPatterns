...
class Car {
    ...
    private var drivers = [Driver(isGood: true, name: "Mark"),
                           Driver(isGood: false, name: "Ivan"),
                           Driver(isGood: true, name: "Mary"),
...
let nextGoodDriver = goodDriverIterator.next()

let goodDriverIteratorViaSequence = car.makeIterator()
let nextGoodDriverViaSequence = goodDriverIteratorViaSequence.next()
let allGoodDrivers = goodDriverIteratorViaSequence.allDrivers()

let badDriveIterator = car.badDriverIterator
let nextBadDriver = badDriveIterator.next()
